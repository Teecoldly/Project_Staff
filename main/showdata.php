...
$key = $_GET["Key"];
     $result = querydata("SELECT * FROM `elderlypeople` WHERE ep_key = '".$key."'");
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="form-group nk-datapk-ctm form-elet-mg" id="data_2">
                                                <div class="input-group date nk-int-st">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="กรุณาเลือกวันเดือนปีเกิด"
                                                        value="<?php echo $data['ep_birthday'];?>" id="birthday" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="alert-inner">
                                            ...
                                            <div class="alert-list">
                                                <div class="alert alert-danger alert-mg-b-0" role="alert"><center>ไม่พบข้อมูลการบันทึกในระบบ</center>
                                                </div>
                                            </div>
                                        </div>
                                    <?php }?>
                        ...
                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="nk-int-st">
                                                        <input type="text" class="form-control input-sm"
                                                            placeholder="กรอกเบอร์โทรที่สะดวกติดต่อ" id="numberphone"
                                                            value="<?php echo $data['ep_numberphone_1'];?>" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="nk-int-st">
                                                        <input type="text" class="form-control input-sm"
                                                            placeholder="กรอกเบอร์โทรที่สะดวกติดต่อ" id="numberphone"
                                                            value="<?php echo $data['ep_numberphone_2'];?>" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-example-wrap mg-t-20">
                                    <div class="cmp-tb-hd cmp-int-hd">
